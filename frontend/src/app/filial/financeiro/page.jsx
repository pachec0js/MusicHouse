...
import FinanceiroHeader from "@/components/FinanceiroFilial/FinanceiroHeader";
import FinanceiroCards from "@/components/FinanceiroFilial/FinanceiroCards";
import ModalAdicionarDespesa from "@/components/FinanceiroFilial/ModalAdicionarDespesa";
import TabelaFinanceiro from "@/components/FinanceiroFilial/Tabela/TabelaFinanceiro";
import TabelaVendas from "@/components/FinanceiroFilial/TabelaVendas/TabelaVendas";
    ...
    async function carregarLucro() {
      try {
        const res = await fetch(
          "http://localhost:8080/despesas/franquia/totalLucroMes?id_franquia=2", {
          cache: 'no-store',
          credentials: 'include',
        }
        );
