...
export default function ModalAdicionarDespesa({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-[500px] bg-[#00263a] text-white border border-zinc-700 shadow-xl">
        <DialogHeader>
        ...
        <div className="grid gap-4">
          ...
          <div className="grid gap-2">
            ...
            <input
              ...
              className="w-full rounded-lg bg-[#003049] text-white px-3 py-2"
            />
          </div>
        ...
        {erroForm && (
          <div className="bg-[#003049] text-white px-3 py-2 rounded-lg text-sm mt-4">
            {erroForm}
          </div>
        )}
        ...
        <DialogFooter className="flex gap-3 justify-end mt-4">
          <Button
            ...
            className="bg-[#003049] hover:bg-[#17225a] text-white  "
          >
            Salvar
          </Button>
