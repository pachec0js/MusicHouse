  ...
  return (
    <div className="space-y-6">
      ...
      <Dialog open={openConfirmarPagar} onOpenChange={setOpenConfirmarPagar}>
        <DialogContent className="bg-[#003049] text-white border border-green-900 max-w-sm">
          <DialogHeader>
      ...
      <Dialog open={openDelete} onOpenChange={setOpenDelete}>
        <DialogContent className="bg-[#00263a] text-white border border-red-900 max-w-sm">
          <DialogHeader>
            ...
            {produtosPagina.length ? (
              produtosPagina.map((p) => (
                ...
                >
                  ...
                  <td className="p-3">
                    <span className="px-3 py-2 rounded bg-[#00263a] text-xs">
                      {p.categoria}
                    </span>
                  </td>
